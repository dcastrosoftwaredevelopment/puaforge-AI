...
// Loaded only when a code modal is opened — not in the initial bundle
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6" onClick={() => setExpanded(false)}>
          ...
          >
            ...
            <div className="overflow-auto flex-1">
              <Suspense fallback={
                <pre className="m-0 p-4 bg-[#0D0D0D] text-[11.5px] font-mono text-[#94a3b8] leading-relaxed whitespace-pre">{code}</pre>
              }>
                <SyntaxHighlighter
