...
import {
  paddingTopAtom, paddingRightAtom, paddingBottomAtom, paddingLeftAtom,
  marginTopAtom, marginRightAtom, marginBottomAtom, marginLeftAtom,
} from '@/atoms';
