...
export const en = {
  ...
  projects: {
    ...
    teamSharingTitle: 'Share project',
    teamSharingHint: 'Choose the teams that will have access to this project.',
    noTeams: 'You have no teams. Create a team first.',
  },
  ...
  team: {
    title: 'Team',
    limitBadge: '{{used}} / {{limit}} teams',
    limitUnlimited: 'Unlimited',
    newTeam: 'New team',
    createTeam: 'Create team',
    teamName: 'Team name',
    teamNamePlaceholder: 'e.g. Marketing, Clients, Dev...',
    ownerBadge: 'Owner',
    memberBadge: 'Member',
    ...
    errors: {
      ...
      userNotActive: 'The user is not active on the platform.',
      cannotAddSelf: 'You cannot add yourself.',
      generic: 'Error processing request. Please try again.',
    },
  },
  ...
  login: {
    ...
    errors: {
      ...
      accountPendingApproval: 'Your account is awaiting administrator approval.',
