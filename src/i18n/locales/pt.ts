...
export const pt = {
  ...
  projects: {
    ...
    teamSharingTitle: 'Compartilhar projeto',
    teamSharingHint: 'Escolha as equipes que terão acesso a este projeto.',
    noTeams: 'Você não tem equipes. Crie uma equipe primeiro.',
  },
  ...
  adminUsers: {
    ...
    confirmBlock: 'Tem certeza que deseja bloquear este usuário?',
  },

  team: {
    title: 'Equipe',
    limitBadge: '{{used}} / {{limit}} equipes',
    limitUnlimited: 'Ilimitado',
    newTeam: 'Nova equipe',
    createTeam: 'Criar equipe',
    teamName: 'Nome da equipe',
    teamNamePlaceholder: 'Ex: Marketing, Clientes, Dev...',
    ...
    addMemberPlaceholder: 'Email do usuário',
    addMemberButton: 'Adicionar',
    removeMember: 'Remover',
    leaveTeam: 'Sair da equipe',
    deleteTeam: 'Excluir equipe',
    confirmDelete: 'Tem certeza que deseja excluir esta equipe? Esta ação não pode ser desfeita.',
    ...
    errors: {
      ...
      userNotActive: 'O usuário não está ativo na plataforma.',
  ...
  editor: {
    ...
    newFilePlaceholder: 'ex: components/Button.tsx',
  },
  ...
  login: {
    ...
    errors: {
      ...
      accountPendingApproval: 'Sua conta está aguardando aprovação do administrador.',
