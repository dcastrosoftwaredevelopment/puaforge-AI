  ...
  billing: {
    ...
    features: {
      ...
      indie: {
        ...
        publish: 'Publicação (subdomínio)',
        domain: '1 domínio customizado',
        import: 'Importar site — 3×/mês',
        images: 'Imagens — 100MB',
        checkpoints: 'Checkpoints — 10 por projeto',
      },
      pro: {
        projects: 'Projetos ilimitados',
        preview: 'Preview ao vivo',
        export: 'Export ZIP + build standalone',
        publish: 'Publicação ilimitada',
        domains: '5 domínios customizados',
        import: 'Importar site — ilimitado',
        images: 'Imagens — 1GB',
        checkpoints: 'Checkpoints ilimitados',
      },
    },
  },
} as const
